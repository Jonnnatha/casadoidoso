...
<?php $this->load->view('Lista/coluna'); ?>
    ...
    <thead class="thead-light">
      ...
      <tr><td style="font-weight: bold;">NOME</td><td style="font-weight: bold;">DATA DE NASCIMENTO</td><td style="font-weight: bold;">GÊNERO</td>
